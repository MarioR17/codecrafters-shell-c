...
- [X] If not a builtin command, "1. Search for an executable with the given name in the directories listed in PATH (just like type does)"
- [X] If executable found, "2. If found, execute the program"
- [X] "3. Pass any arguments from the command line to the program"
